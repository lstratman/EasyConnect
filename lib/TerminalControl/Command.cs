...
//            AddKeyMap(Category.Edit, Target.Connection, CID.PasteFromFile,       "Command.PasteFromFile",           Keys.None, Keys.None);
            AddKeyMap(Category.Edit, Target.Connection, CID.ClearScreen,         "Command.ClearScreen",             Keys.Alt, Keys.L);
//            AddKeyMap(Category.Edit, Target.Connection, CID.ClearBuffer,         "Command.ClearBuffer",             Keys.Alt, Keys.L);
