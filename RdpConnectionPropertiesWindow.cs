...
{
    public partial class RdpConnectionPropertiesWindow : Form
    {
        ...
        public RdpConnectionPropertiesWindow(MainForm applicationForm, BookmarksFolder currentFolder = null)
            : this(applicationForm, new RdpConnection(applicationForm.Password), currentFolder)
        {
        }

        public RdpConnectionPropertiesWindow(MainForm applicationForm, RdpConnection connection, BookmarksFolder currentFolder = null)
        {
            InitializeComponent();
        ...
        private void saveAsButton_Click(object sender, EventArgs e)
        {
            ...
            if (_connection == null)
            {
                _connection = new RdpConnection(_applicationForm.Password)
                                  {
        ...
        {
            RdpConnection newConnection = new RdpConnection(_applicationForm.Password)
                                              {
